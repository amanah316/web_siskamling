...
<!-- Button -->
	...
	<table border="1"class="table bordered">
		...
		<th style= "background-color:  #b2dafa; color:#fff;">MINGGU</th>
		<th style= "background-color:  #b2dafa; color:#fff;">SHIFT</th>
		 ...
		 if(isset($_GET['cari'])){
		   $cari = $_GET['cari'];
		   $data = mysqli_query($koneksi, "SELECT * FROM vjadwal WHERE id_jadwal LIKE '%$cari%' OR nik LIKE '%$cari%' OR nama LIKE '%$cari%' OR tanggal_bertugas LIKE '%$cari%' OR  Minggu LIKE '%$cari%' OR  Shift LIKE '%$cari%'");
		 } else {
